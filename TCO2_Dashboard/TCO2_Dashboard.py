...
app.layout=html.Div([
  ...
  ,style ={'textAlign': 'center','padding':'3%','color':'darkmagenta', 'font-size':'180%'}),


  html.Div([
  html.H1("Summary")]
  ,style ={'textAlign': 'center','padding':'5%','color':'deeppink','font-size':'150%'}),
  ...
  ,style ={'textAlign': 'center','padding':'1%', 'color':'black','font-size':'120%'}),
...
html.Div([
  ...
  ,style ={'textAlign': 'center','color':'black','font-size':'120%'}),
